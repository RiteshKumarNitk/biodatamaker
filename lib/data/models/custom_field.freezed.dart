...
class _$CustomFieldImpl implements _CustomField {
  ...
  @override
  String toString() {
    return 'CustomField(id: $id, section: $section, label: $label, value: $value, order: $order)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, section, label, value, order);
...
abstract class _CustomField implements CustomField {
  const factory _CustomField(
      ...
      @HiveField(4) final int order}) = _$CustomFieldImpl;
